...
If you are trying to build the document locally, the easiest way to install asciidoctor is through `gem` the package manager for Ruby.
You may also want these optional Ruby packages:
- coderay
- pygments.rb
